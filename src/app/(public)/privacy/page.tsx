  ...
  return (
    <div className="container py-20 max-w-4xl">
      <div className="space-y-6 mb-16 border-b pb-8">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight">{getContent(blocks, 'privacy.title', "Privacy Policy")}</h1>
      ...
      <div className="space-y-16">
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">{getContent(blocks, 'privacy.1.title', "1. Introduction")}</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">{getContent(blocks, 'privacy.2.title', "2. Data We Collect")}</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">{getContent(blocks, 'privacy.3.title', "3. Usage of Information")}</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">{getContent(blocks, 'privacy.4.title', "4. Data Security")}</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4 pt-8 border-t">
          <h2 className="text-2xl font-bold text-foreground">{getContent(blocks, 'privacy.contact.title', "Contact Our Privacy Officer")}</h2>
          ...
          <div className="mt-4 p-6 border rounded-xl inline-block pr-12">
             ...
             <p className="text-muted-foreground">{getContent(blocks, 'privacy.contact.phone', "+86 10 1234 5678")}</p>
          </div>
        </section>
      </div>
    </div>
