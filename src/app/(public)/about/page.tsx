        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2 space-y-8">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
              Pioneering <span className="text-brand-red">Educational Bridges</span> to China
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Founded on the belief that education knows no borders, Sinoway Education has evolved from a small consultancy to a leading authority in Sino-international student exchange. We are more than agents; we are mentors, strategists, and your first family in a new land.
            </p>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            <h2 className="text-3xl font-bold">Core Values Driving Us</h2>
            <p className="text-muted-foreground">The principles that guide every interaction and decision.</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Integrity First", desc: "Transparent processes with no hidden fees or false promises." },
              { title: "Student-Centric", desc: "Your academic goals and personal well-being are our top priority." },
              { title: "Excellence", desc: "We strive for the highest standards in application quality and support." }
            ].map((value, i) => (
